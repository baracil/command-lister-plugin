...
public class JPlugin extends ExtensionPlugin {
    ...
    public static final ImmutableSet<Requirement<?>> REQUIREMENTS = ImmutableSet.of(Requirements.IO, Requirements.COMMAND_DECLARATION_LISTER);

    public JPlugin() {
        super(CommandListerPlugin::new, REQUIREMENTS);
    }
